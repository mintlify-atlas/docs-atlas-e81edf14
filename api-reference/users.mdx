---
title: "Users and Roles API Endpoints"
sidebarTitle: "Users"
description: "REST endpoints for user management in SCO Autolavados — login, registration, cedula lookup, user update with photo upload, and role filtering."
---
