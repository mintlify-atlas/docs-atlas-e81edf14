---
title: "Services Catalog API Endpoints"
sidebarTitle: "Services"
description: "REST endpoints for managing the SCO Autolavados service catalog — create, list, and update wash services with pricing, estimated time, and vehicle type targeting."
---
