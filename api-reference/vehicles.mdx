---
title: "Vehicles (Cars) API Endpoints"
sidebarTitle: "Vehicles"
description: "REST endpoints for managing vehicles and vehicle types in SCO Autolavados — register, search by plate, update, and manage type categories."
---
...
### `PUT /api/cars/:id` <Icon icon="lock" /> Any authenticated user

Updates one or more fields of an existing vehicle record.
