---
title: "Dashboard KPIs API Endpoint"
sidebarTitle: "Dashboard"
description: "GET /api/dashboard/kpis returns real-time business analytics for the SCO Autolavados admin panel — revenue, balances, top customers, and service metrics."
---
