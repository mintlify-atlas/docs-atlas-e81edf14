...
description: "Three roles — Admin, Customer, and Laundrer — govern access in SCO Autolavados, each with distinct creation flows and JWT-enforced permissions."
---
